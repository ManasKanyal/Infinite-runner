...
if(gameState  === "raceStartChiron" && keyDown("right")&& buggati.x < 980 ){
...
if(gameState  === "raceStartChiron" && keyDown("up") && buggati.y > 20){
  ...
  if(gameState  === "raceStartFerrari" && keyDown("down")&& formula.y < 580 ){
    ...
    if(gameState  === "raceStartFerrari" && keyDown("right")&& formula.x < 980 ){
...
function otherCars() {
  ...
  if(frameCount % 80 === 0) {
    ...
    var car = createSprite(1000,Math.round(random(50,600)));
